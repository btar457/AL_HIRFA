...
class _ArtisanProfileScreenState extends State<ArtisanProfileScreen> {
  final _nameController = TextEditingController(text: 'أبو مصطفى');
  final _craftController = TextEditingController(text: 'نحاسيات وأعمال معدنية');
  final _experienceController = TextEditingController(text: '12');
  final _bioController = TextEditingController(text: 'حرفي عراقي متخصص في صناعة النحاسيات منذ أكثر من عقد.');
  final _ibanController = TextEditingController(text: 'IQ98IHRF00000000004821');
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 14),
                  _buildLabeledField(label: 'الحرفة / التخصص', field: TextFormField(controller: _craftController, style: const TextStyle(color: AppColors.text), decoration: _fieldDecoration())),
                  const SizedBox(height: 14),
                  ...
                  const SizedBox(height: 14),
                  _buildLabeledField(label: 'نبذة عنك', field: TextFormField(controller: _bioController, maxLines: 4, style: const TextStyle(color: AppColors.text), decoration: _fieldDecoration())),
                  const SizedBox(height: 20),
                  _buildBankSection(),
                ],
              ),
            ...
            _buildSettingsTile(icon: Icons.notifications_outlined, title: 'إعدادات الإشعارات'),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text('يُستخدم لتحويل أرباحك', style: TextStyle(color: AppColors.subText, fontSize: 11)),
        ],
      ),
    );
  }
