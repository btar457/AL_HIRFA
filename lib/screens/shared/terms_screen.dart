...
class TermsScreen extends StatelessWidget {
  ...
  static const _buyerRules = [
    ...
    'يحق لك رفض المنتج التالف أو المختلف عمّا طلبته دون أي التزام بالدفع',
    'قيّم تجربتك خلال 7 أيام',
    'عند وجود خلاف حول طلب، افتح بلاغاً من داخل التطبيق — تراجعه الإدارة وتفصل فيه خلال 48 ساعة',
  ...
  static const _artisanRules = [
    ...
    'قسم شركات الشحن مغلق مؤقتاً — أنت المسؤول عن توصيل طلباتك وتحصيل المبلغ كاشاً من الزبون مباشرة',
    'عمولة المنصة 5% من سعر المنتج فقط (لا تُحتسب على رسم التوصيل)، وتُسجَّل كمبلغ مستحق عليك تسدّده للمنصة لاحقاً (تحويل بنكي) — راجع "عمولة مستحقة عليك" في لوحتك',
    'التأخر في سداد العمولة المستحقة شهراً كاملاً = تنبيه أول، ثم تنبيه ثانٍ وأخير بعد شهر آخر بلا سداد، ثم حظر تلقائي للحساب إن لم تستجب لأي من التنبيهين',
    '3 رفضات متتالية = تحذير رسمي',
  ];

  static const _shippingRules = [
    '⏸ قسم شركات الشحن مغلق مؤقتاً — البنود التالية غير مُفعَّلة حالياً وتخص الحسابات القديمة فقط',
